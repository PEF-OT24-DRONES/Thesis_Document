...
%%ELECTRONICS SOA
    ...
    \bibitem{px4_docs} PX4 Documentation, ``PX4 is a powerful open source autopilot flight stack running on the NuttX RTOS.'' Disponible en: \url{https://docs.px4.io/main/en/}.
...
\bibitem{researchgate_orientation}
