...
\begin{titlepage}
    ...
    \vspace{1.5cm}
    {\large\textbf{30 de noviembre 2024}} % Fecha de presentación
    
    \vfill
    {\large\textbf{Asesor:} \text{Fermín Castro Aragón}} % Información del asesor
...
\chapter{Resultados} % Capítulo principal de desarrollo
