...
\input{chapters/introduccion} % Llama al archivo 'introduccion.tex' desde la carpeta 'chapters'

\chapter{State of the Art} % Capítulo de estado del arte
\input{chapters/estado_arte} % Llama al archivo 'estado_arte.tex' desde la carpeta 'chapters'

\chapter{Development} % Capítulo principal de desarrollo
\input{chapters/desarrollo} % Llama al archivo 'desarrollo.tex' desde la carpeta 'chapters'

\chapter{Results} % Capítulo principal de desarrollo
\input{chapters/resultados} % Llama al archivo 'resultados.tex' desde la carpeta 'chapters'

\chapter{Discussion} % Capítulo de discusión
\input{chapters/discussion} % Llama al archivo 'discussion.tex' desde la carpeta 'chapters'

\chapter{Conclusions} % Capítulo de conclusiones
\input{chapters/conclusiones} % Llama al archivo 'conclusiones.tex' desde la carpeta 'chapters'
